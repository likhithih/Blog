...
<section className="pb-12 mx-auto md:pb-20 max-w-7xl">
    ...
    <div className="gap-8 space-y-8 md:columns-2 lg:columns-3">
        ...
        <div className="p-8 bg-white border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10">
            ...
            <p className="mt-8">The articles on this blog are insightful and well-researched. They cover the latest in tech trends and provide practical advice. Highly recommend for anyone in the industry!</p>
        </div>
        ...
        <div className="p-8 bg-white border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10">
            ...
            <p className="mt-8">I love the diverse topics! From digital marketing strategies to creative content ideas, this blog has it all. The writing is engaging and easy to follow.</p>
        </div>
        ...
        <div className="p-8 bg-white border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10">
            ...
            <p className="mt-8">This blog is a game-changer for developers. The tutorials and code examples are spot-on, and they keep me updated on the latest frameworks and tools.</p>
        </div>
        ...
        <div className="p-8 bg-white border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10">
            ...
            <p className="mt-8">The navigation is super easy, and the content is well-organized. I always find something new and useful in every post. My go-to resource for tech insights.</p>
        </div>
        ...
        <div className="p-8 bg-white border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10">
            ...
            <p className="mt-8">Great value for readers. The blog posts are high-quality and free, yet they provide immense value. It's significantly improved my knowledge in the field.</p>
        </div>
        ...
        <div className="p-8 bg-white border border-gray-100 shadow-2xl aspect-auto rounded-3xl shadow-gray-600/10">
            ...
            <p className="mt-8">Absolutely love this blog. The design tips and industry trends are spot-on, and the community engagement makes it even better. My favorite online resource!</p>
        </div>
