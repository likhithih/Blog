...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Example: show alert only when response is OK
    ...
    <div className="flex h-screen w-full">
      <div className="w-full hidden md:flex md:items-center md:justify-center">
        <img
          ...
          src="https://cdn.pixabay.com/photo/2022/07/08/05/48/blogging-7308532_1280.png"
          alt="leftSideImage"
        />
      </div>
      ...
      <div className="w-full flex flex-col items-center justify-center">
        ...
        >
          ...
          {err && (
            <p className="text-red-500 text-sm mt-3 bg-red-100 px-3 py-2 rounded w-full text-center">
              {err}
            </p>
          )}
