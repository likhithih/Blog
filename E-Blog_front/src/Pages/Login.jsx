...
import { auth, provider } from "../firebaseConfig"; // ✅ Firebase imports
...
export default function Login() {
    ...
    const handleGoogleSignIn = async () => {
        try {
            ...
            // Send user data to backend for authentication/creation
            const response = await axios.post('http://localhost:4000/google-signin', {
